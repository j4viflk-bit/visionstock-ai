...
export default function LoginPage() {
  ...
  return (
    <main style={{ display: 'flex', minHeight: '100vh', fontFamily: "'Inter', -apple-system, sans-serif" }}>
      ...
      <div className="login-left" style={{ flex: 1.2, position: 'relative', overflow: 'hidden', minHeight: '100vh' }}>
        <img src="/quiebredestock.png" alt="VisionStock AI" style={{ width: '100%', height: '100%', objectFit: 'cover', position: 'absolute', inset: 0 }} />
        ...
        <div style={{ position: 'relative', zIndex: 10, height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '36px 44px' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', background: 'rgba(255,255,255,0.05)', borderRadius: 12, border: '1px solid rgba(255,255,255,0.08)', overflow: 'hidden' }}>
              {[
      ...
      <div className="login-right" style={{ width: 460, background: '#F4F4F5', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '48px 40px', flexShrink: 0 }}>

        {/* Logo mobile */}
        <div className="login-logo-mobile" style={{ display: 'none', alignItems: 'center', gap: 10, marginBottom: 32 }}>
          <div style={{ width: 36, height: 36, background: '#0EA5E9', borderRadius: 10, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <svg style={{ width: 18, height: 18, color: '#fff' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.069A1 1 0 0121 8.882v6.236a1 1 0 01-1.447.894L15 14M3 8a2 2 0 012-2h8a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V8z" />
            </svg>
          </div>
          <div>
            <div style={{ color: '#09090B', fontSize: 16, fontWeight: 700 }}>VisionStock AI</div>
            <div style={{ color: '#A1A1AA', fontSize: 10 }}>Monitoreo inteligente</div>
          </div>
        </div>
        ...
        <div style={{ width: '100%', maxWidth: 360 }}>
          ...
          <div style={{ background: '#fff', borderRadius: 16, padding: '28px 24px', border: '1px solid #E4E4E7', boxShadow: '0 1px 3px rgba(0,0,0,0.06)', display: 'flex', flexDirection: 'column', gap: 18 }}>
            <div>
              <label style={{ fontSize: 12, fontWeight: 500, color: '#52525B', display: 'block', marginBottom: 7 }}>Correo electrónico</label>
              <input
                type="email"
                ...
                style={{ width: '100%', padding: '11px 14px', borderRadius: 10, fontSize: 13, border: '1.5px solid #E4E4E7', background: '#FAFAFA', color: '#09090B', outline: 'none', boxSizing: 'border-box', transition: 'all 0.15s' }}
            ...
            <div>
              <label style={{ fontSize: 12, fontWeight: 500, color: '#52525B', display: 'block', marginBottom: 7 }}>Contraseña</label>
              <input
                type="password"
                placeholder="••••••••"
                value={password}
            ...
            <button
              onClick={handleLogin}
              disabled={loading}
              style={{ width: '100%', padding: '12px 14px', borderRadius: 10, fontSize: 13, fontWeight: 600, border: 'none', cursor: loading ? 'not-allowed' : 'pointer', background: loading ? '#BAE6FD' : '#0EA5E9', color: '#fff', transition: 'all 0.15s', marginTop: 2 }}

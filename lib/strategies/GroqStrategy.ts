      ...
      body: JSON.stringify({
        ...
        messages: [{
          ...
          content: [
            {
              type: 'text',
              text: `Eres un sistema experto en gestión de inventario retail. Analiza esta imagen con máximo detalle y precisión.
...
Responde SOLO con este JSON exacto, sin texto adicional:
{
  ...
  "description": "descripción objetiva del estado actual"
}
...
- En recomendacion indica qué productos reponer basándote en los que aún quedan visibles
...
SIEMPRE sé específico en zonas y marcas si son legibles.`
            },
            {
              type: 'image_url',
